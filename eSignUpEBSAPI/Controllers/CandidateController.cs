...
namespace eSignUpEBSAPI.Controllers
{
    ...
    public class CandidateController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create(CandidateModel newRecord)
        {
            ...
            return CreatedAtAction(nameof(GetAsync), new { Record.ID }, newRecord);
        }
        ...
        public async Task<IActionResult> CreateMany(IEnumerable<CandidateModel> newRecords)
        {
            ...
            return CreatedAtAction(nameof(GetAllAsync), new { IDs = ids }, newRecords);
        }
        ...
        public async Task<IActionResult> Update(int recordID, CandidateModel updatedRecord)
        {
            ...
            return AcceptedAtAction(nameof(GetAsync), new { recordID = Record.ID  }, updatedRecord);
        }
        ...
        public async Task<IActionResult> UpdateMany(IEnumerable<CandidateModel> updatedRecords)
        {
            ...
            return AcceptedAtAction(nameof(GetManyAsync), new { IDs = Records.Select(r => r.ID) }, updatedRecords);
        }
        ...
        public async Task<IActionResult> Delete(int recordID)
        {
            ...
            var recordToDelete = await _apiService.GetAsync(recordID);
            ...
            return AcceptedAtAction(nameof(GetAsync), new { }, recordToDelete);
        }
        ...
        public async Task<IActionResult> DeleteMany(IEnumerable<CandidateModel> recordsToDelete)
        {
            ...
            return AcceptedAtAction(nameof(GetManyAsync), new { IDs = Records.Select(r => r.ID) }, recordsToDelete);
        }
        ...
        public async Task<IActionResult> DeleteAll(string confirm)
        {
            ...
            return AcceptedAtAction(nameof(DeleteAll), new { }, null);
        }
